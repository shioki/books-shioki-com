...
(function (global) {
  ...
  var CATEGORY_LABELS = {
    ...
    'コミック・ラノベ・BL': { en: 'Comics / Light Novels / BL', 'zh-tw': '漫畫・輕小說・BL' },
    'コミック':             { en: 'Comics / Manga',       'zh-tw': '漫畫' },
  ...
  var THEMES = [
    ...
    },
    {
      ...
      cats: ['文学・評論', '小説・文芸', '日本の小説・文芸', '外国文学研究', '近現代の作品', '評論・文学研究', '英米文学', '英米の小説・文芸', 'その他の外国文学', '小説', 'イギリス・アメリカ', 'コミック・ラノベ・BL', 'コミック']
    },
    {
      id: 'society',
